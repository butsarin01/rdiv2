...
@section('slider1')
	<!-- Feature post -->
	<section class="bg0" style="background-image: url('images/t11.jpg');">
		<div class="container">
		...
		<div class="container">
			<div class="row m-rl--1">
				...
				<div class="col-sm-6 col-lg-4 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-12 how1 pos-relative" style="background-image: url({{$event->cover_url}});">
						<a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
			...
			<div class="tab01 p-b-20">
				<div class="tab01-head how2 how2-cl2 bocl12 flex-s-c m-r-10 m-r-0-sr991">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#tab1-1" role="tab">ข่าว/ประกาศ</a>
						</li>
		...
		<div class="col-sm-4 p-r-25 p-r-15-sr991">
			<div class="m-b-45">
				<a href="" class="wrap-pic-w hov1 trans-03">
					<img src="{{$event->cover_link}}" alt="IMG" style="height: 150px; width: auto;">
				</a>
...
@section('product')
	<div class="col-md-12 col-lg-12 p-b-20" >
		...
		<div class="row p-t-35" style="background-color: #efefef">
