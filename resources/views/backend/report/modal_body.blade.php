<div class="modal-body">
    ...
    <input type="hidden" name="base" value="report">
...
{{--    <div class="div-show-title hide" data-number_div="3">--}}
{{--        <div class="form-group row mb-1">--}}
{{--            <label class="col-md-3 col-sm-3 col-form-label" for="file">รายละเอียดเพิ่มเติม <br>ของหัวข้อ:</label>--}}
{{--            <div class="col-md-9 col-sm-9">--}}
{{--            <textarea class="form-control text-title-detail" rows="7" name="detail_title"></textarea>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
    <div class="div-show-Subtitle hide" data-number_div="4">
        <div class="form-group row mb-1">
            <label class="col-md-3 col-sm-3 col-form-label" for="file">รายละเอียดเพิ่มเติม <br>ของหัวข้อย่อย:</label>
            <div class="col-md-9 col-sm-9">
            <textarea class="form-control text-Subtitle-detail" rows="7" name="detail_Subtitle"></textarea>
            </div>
        </div>
    </div>
