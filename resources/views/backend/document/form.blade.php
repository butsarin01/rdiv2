...
<form action="{{ route('document.insert') }}" method="POST" name="summernote_form" enctype="multipart/form-data">
    ...
    <input class="form-control hide" type="text" id="document_id" name="document_id" placeholder=""
        value="{{ $id }}" />
    <input class="form-control hide" type="text" id="mode" name="mode" placeholder="" value="document" />
    ...
    <div class="form-group row mb-1">
        ...
        <div class="col-md-8 col-sm-8">
            ...
            {{--                                            <label class="col-md-2 col-sm-2 col-form-label" for="file">file :</label> --}}
            {{--                                            <div class="col-md-10 col-sm-10  div-multifile"> --}}
            {{--                                                <div class="row "> --}}
            {{--                                                    <div class="col-md-10 col-sm-10"> --}}
            ...
            <div class="form-group row mb-1">
                <label class="col-form-label col-md-2">ประเภทเอกสาร:</label>
                <div class="col-md-6">
                ...
                <div id="loading_type_document_id" class="col-md-1 hide"><i class="fas fa-spinner fa-pulse"></i></div>
            </div>

            <div class="form-group row mb-1">
                <label class="col-form-label col-md-2">หมวดหมู่เอกสาร:</label>
                <div class="col-md-6">
            ...
            <div class="form-group row mb-1">
                ...
                <div class="col-md-6">
                    <input class="hide" type="text" name="select_value_title"
                        value="{{ $title_document_id }}">
                    <select class="form-select title_document_id dynamic_input_Subtitle" id="title_document_id"
                        name="title_document_id" data-dependent="sub_title_document_id">
                        {{--                        <option value="0">เลือกหัวข้อ..</option> --}}
                    </select>
                </div>
                <div id="loading_title_document_id" class="col-md-1 hide"><i class="fas fa-spinner fa-pulse"></i>
                </div>
            </div>
            <div class="form-group row mb-1">
                <label class="col-md-2 col-sm-2 col-form-label" for="file">หัวข้อย่อย :</label>
                <div class="col-md-6">
                    <input class="hide" type="text" name="select_value_subtitle"
                        value="{{ $sub_title_document_id }}">
                    ...
                    <div class="card border-warning text-warning">
                        <div class="card-body div-multifile">
                            <div class="row ">
                                ...
                                <label class="col-md-1 col-sm-1 col-form-label text-end" for="file">file :</label>
                                <div class="col-md-5 col-sm-5 ">
                                    <div class="row ">
                                        <div class="col-md-10 col-sm-10">
                                            <input class="form-control" type="file" id="multifilename"
