            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="card bg-dark text-white">
                        <div class="card-header bg-dark-darker pointer-cursor d-flex align-items-center"
                            ...
                            @foreach($set_document_setting as $type)
                                <tr id="{{$type->id}}">
                                    <td>
                                        ...
                                        <h5>
                                            <i class="far fa-lg fa-fw me-2 fa-folder"></i>{{$type->name}}
                                        </h5>
                                        {{-- </a> --}}
                                    </td>
                                    <td>
                                        {{--                                            <a href="#modal-dialog-editText" class="btn btn-sm btn-warning editText"--}}
                                        {{--                                                data-toggle="modal" data-target="#modal-dialog-editText"--}}
                                        {{--                                                id="editText" data-id="{{$type->id}}">--}}
                                        {{--                                                <i class="far fa-lg fa-fw m-r-3 fa-edit"></i>แก้ไข--}}
                                        {{--                                            </a>--}}
                                        <a href="#modal-dialog-addType" class="btn btn-sm btn-warning editType"
                                           data-toggle="modal" data-target="#modal-dialog-addType"
                                           data-id="{{$type->id}}" data-mode="type"><i
                                                class="far fa-lg fa-fw m-r-3 fa-edit"></i>แก้ไขประเภท</a>
                                ...
                                @foreach($type->category as $category)
                                    <tr>
                                        <td class="ps-30px">
                                            <h5 class="">
                                                <i class="fas fa-lg fa-fw me-2 fa-genderless"></i>{{$category->name}}
                                            </h5>
                                        </td>
                                        <td>
                                            {{--                                                <a href="#modal-dialog-editText" class="btn btn-sm btn-warning editText"--}}
                                            {{--                                                    data-toggle="modal" data-target="#modal-dialog-editText"--}}
                                            {{--                                                    id="editText" data-id="{{$category->id}}">--}}
                                            {{--                                                    <i class="far fa-lg fa-fw m-r-3 fa-edit"></i>แก้ไข--}}
                                            {{--                                                </a>--}}
                                            <a href="#modal-dialog-addCategory"
                                               class="btn btn-sm btn-warning editCategory"
                                               data-toggle="modal" data-target="#modal-dialog-addCategory"
                                               data-id="{{$category->id}}" data-mode="category">
                                    ...
                                    @foreach($category->title as $title)
                                        <tr>
                                            ...
                                            <td>
                                                {{--                                                    <a href="#modal-dialog-editText" class="btn btn-sm btn-warning editText"--}}
                                                {{--                                                        data-toggle="modal" data-target="#modal-dialog-editText"--}}
                                                {{--                                                        id="editText" data-id="{{$title->id}}">--}}
                                                {{--                                                        <i class="far fa-lg fa-fw m-r-3 fa-edit"></i>แก้ไข--}}
                                                {{--                                                    </a>--}}
                                                <a href="#modal-dialog-addTitle"
                                                   class="btn btn-sm btn-warning editTitles"
                                                   data-toggle="modal" data-target="#modal-dialog-addTitle"
                                                   data-id="{{$title->id}}" data-mode="title">
                                        ...
                                        @foreach($title->sub_title as $sub_title)
                                            <tr>
                                                ...
                                                <td>
                                                    {{--                                                        <a href="#modal-dialog-editText" class="btn btn-sm btn-warning editText"--}}
                                                    {{--                                                            data-toggle="modal" data-target="#modal-dialog-editText"--}}
                                                    {{--                                                            id="editText" data-id="{{$sub_title->id}}">--}}
                                                    {{--                                                            <i class="far fa-lg fa-fw m-r-3 fa-edit"></i>แก้ไข--}}
                                                    {{--                                                        </a>--}}
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('category_document.insert')}}" id="form_addCategory">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-7 col-sm-7">
                                <input class="form-control text-type-name" type="text" id="name_type_modal"
                                       name="name_type" placeholder="" disabled/>
                                <input class="form-control text-type-id " type="hidden" id="id_type_modal"
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <input class="form-control text-category-ordinal" type="text" id="ordinal_Category"
                                       name="ordinal_Category" placeholder=""/>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6  float-right ">
                            <button type="submit"
                    ...
                    <form method="POST" action="{{route('title_document.insert')}}" id="form_addTitle">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="name_type">ประเภทของเอกสาร
                                :</label>
                            <div class="col-md-7 col-sm-7">
                                <input class="form-control text-type-name" type="text" id="name_type_title"
                                       name="name_type"
                                       placeholder="" disabled/>
                                <input class="form-control hide text-type-id" type="text" id="id_type_title"
                                       name="id_type"
                                       placeholder=""/>
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <input class="form-control hide text-category-id" type="text" id="id_category"
                                       name="id_category"
                                       placeholder=""/>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="name_type_SubTitles">ประเภทของเอกสาร
                                :</label>
                            <div class="col-md-7 col-sm-7">
                                <input class="form-control text-type-name" type="text" id="name_type_SubTitles"
                                       name="name_type" placeholder="" disabled/>
                                <input class="form-control hide text-type-id" type="text" id="id_type_SubTitles"
                                       name="id_type" placeholder=""/>
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-4 col-sm-4 col-form-label" for="name_category_SubTitles">หมวดหมู่ของเอกสาร
                                :</label>
                            <div class="col-md-7 col-sm-7">
                                <input class="form-control text-category-name" type="text" id="name_category_SubTitles"
                                       name="name_category" placeholder="" disabled/>
                                <input class="form-control hide text-category-id" type="text" id="id_category_SubTitles"
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-7 col-sm-7">
                                <input class="form-control text-title-name" type="text" id="name_title_SubTitles"
                                       name="name_titles" placeholder="" disabled/>
                                <input class="form-control hide text-title-id" type="text" id="id_title_SubTitles"
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control text-Subtitle-code" type="text" id="code_Subtitle"
                                       name="code_Subtitle" placeholder=""/>
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
