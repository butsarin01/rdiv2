									...
									@else
										<li >
											...
											@elseif(!empty($main->id == 6))
												<a href="{{ route($main->join_database == 'type_document' ? 'index.document_all' : $main->join_database, $main->join_database == 'type_document' && !empty($main->join_database_id) ? [$main->join_database_id] : [4]) }}">{{ $main->name }}</a>
											@endif
										</li>
									@endif
								@else
