            ...
            <div class="panel">
                <div class="panel-body">
                    <div class="card-body">
                        ...
                        <input class="form-control hide" type="text" id="document_id" name="document_id" value="{{$document->id}}"/>
                            ...
                            <div class="col-md-8 col-sm-8">
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-10 col-sm-10">
                                        ...
                                        placeholder="" data-parsley-required="true" value="{{$document->name}}"/>
                                    </div>
                                </div>
                                <div class="form-group row m-b-15">
                                ...
                                <input class="hide" type="text" name="select_value_type_quality" value="{{$document->type_quality_id}}">
                                <input class="hide" type="text" name="select_value_year" value="{{$document->year}}">
                                <input class="hide" type="text" name="select_value_type" value="{{$document->type_document_id}}">
                                ...
                                <input class="hide" type="text" name="select_value_subtitle" value="{{$document->sub_title_document_id}}">
                                ...
                                <div class="form-group row m-b-15">
                                    ...
                                    <div class="col-md-4">
                                        {{ Form::select('type_quality_id', App\Type_quality::all()->pluck('name_th','id'), $document->type_quality_id, ['placeholder' => 'กรุณาเลือกประเภท...','class'=>'form-control dynamic_year','data-dependent'=>'year_id']) }}
                                    </div>
                                </div>
                   ...
                   <div class="row">
                        @foreach($sub_document as $data)
                            <div class="col-md-2 border text-center ">
                                <img src="{{asset('storage/sub_document/'.$document->id.'/'.$data->file)}}" width="100"> <br>
                                {{$data->file}} <br>
                                <a class="btn btn-red btn-sm" href="{{route('sub_document.delete',[$data->id])}}" role="button">ลบ</a>
                            </div>
                        @endforeach
            ...
            // if(!empty(value)){
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        // $('.type_quality_id option[value='+select_value_type_quality+']').prop('selected', true);

                        var select_value_year = $("input[name=select_value_year]").val();
                        $('.year_id option[value='+select_value_year+']').prop('selected', true);

                        var select_value_type = $("input[name=select_value_type]").val();
                        $('.type_document_id option[value='+select_value_type+']').prop('selected', true);
                        ...
                        $('.sub_title_document_id option[value='+select_value_category+']').prop('selected', true);
                    }
                });
            // }
