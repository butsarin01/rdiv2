			...
			<div class="col-xl-12">
				...
				<div class="card ">
					<div class="card-header  pointer-cursor d-flex align-items-center" data-toggle="collapse" data-target="#collapseOne">
						<i class="fas fa-lg fa-fw m-r-10 fa-plus-circle text-blue "></i> แบบบันทึกข้อมูลปฏิทินกิจกรรม
					</div>
						...
						<div class="card-body">
							...
							<div class="form-group row m-b-15">
								<div class="col-md-8 col-sm-8">
									<div class="form-group row m-b-15">
										<label class="col-md-2 col-sm-2 col-form-label" for="fullname">ชื่อหัวข้อ  :</label>
										<div class="col-md-8 col-sm-8">
								...
								<div class="col-md-4 col-sm-4 ">
									<label class="col-md-3 col-sm-3 col-form-label">ไฟล์เอกสาร</label>
